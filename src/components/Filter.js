    ...
    <h3 class="text-2xl font-semibold my-5 text-center">Discover Your Pokemon</h3>
        <div class="flex justify-between items-center bg-black bg-opacity-20  p-4 mb-5">
          <div class="flex">
            ...
            <select class="rounded-lg px-2 py-1 border border-gray-300">
          ...
          <div class="flex  ">
            ...
            <input type="text" class="rounded-lg w-full px-1 py-1 border border-gray-300" placeholder="Search">
          </div>
        </div></div>
      `;
  }
