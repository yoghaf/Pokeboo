class FooterSection extends HTMLElement {
  ...
  render() {
    ...
    <div class="w-full flex justify-center mb-2">
      <div class="w-4/5 border-t border-gray-700"> </div>
    </div>
    <div class="w-full pt-2 justify-center flex">
      <div id="contact-logo" class="flex mb-5">
        <!-- Github -->
        <a href="https://github.com/yoghaf/yoghaf" target="_blank" class="w-9 h-9 mr-3 rounded-full flex items-center justify-center border text-gray-400 border-gray-500 hover:border-blue-500 hover:bg-blue-500 hover:text-white">
          ...
          <!-- Linkedin -->
        <a href="https://www.linkedin.com/in/utomo-yoga-firmansyah-aa2a2b1aa" target="_blank" class="w-9 h-9 mr-3 rounded-full flex items-center justify-center border text-gray-400 border-gray-500 hover:border-blue-500 hover:bg-blue-500 hover:text-white">
            <svg class="fill-current" width="20" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
